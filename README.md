...
`check:scheduler`, `check:rooms`, `check:checklist` กับ `check:xlsx` รัน TypeScript ตรง ๆ ด้วย `node --experimental-strip-types` — ไม่มี build step ไม่มี test framework
