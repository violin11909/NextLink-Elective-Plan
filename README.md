...
- แถบการบันทึกบอกสถานะจริงทุกหน้า · ปุ่มสำรอง/นำเข้า JSON อยู่ที่หน้าภาพรวมแผนหน้าเดียว
  เพราะทำงานกับทั้งแผน ไม่ใช่กับหน้าที่กดอยู่
...
- Undo อยู่ที่ปุ่ม "เลิกทำ" ในแถบแจ้งเตือนหลังทำรายการ ถ้าแท็บอื่นเขียนต่อแล้วจะไม่ย้อนทับงานนั้น
