...
| `/courses/list` | **รายวิชา** — ตารางอ้างอิง ค้นหาด้วยชื่อวิชา ผู้สอน บริษัท หรือหมวด ในช่องเดียว · เลือกดูเทอมย้อนหลังได้ · ดาวน์โหลดเป็น Excel |
...
| `npm run check:xlsx` | 14 เคสของตัวเขียนไฟล์ `.xlsx` และคอลัมน์ที่ส่งออก |
...
`check:scheduler` กับ `check:xlsx` รัน TypeScript ตรง ๆ ด้วย `node --experimental-strip-types` — ไม่มี build step ไม่มี test framework
