...
export type RoomTier =
  ...
  | "NEEDS_APPROVAL";    // ตึก 3 / ตึก 4 ของคณะวิศวะฯ — ต้องยื่นเรื่องก่อน
...
**Tier `NEEDS_APPROVAL` — อาคารคณะวิศวะฯ (ต้องยื่นเรื่องขอใช้ก่อน)**
...
ห้องในตึก 3 / ตึก 4 เป็นของคณะวิศวะฯ ต้องดำเนินเรื่องหลายขั้นตอนกว่าจะใช้ได้
...
// รอบที่ 2 — เฉพาะวิชาที่รอบแรกจัดไม่ลง จึงเปิดห้องคณะวิศวะฯให้
...
การรับประกันจึงเป็นแบบเด็ดขาด: **ไม่มีวิชาใดถูกจัดลงห้องคณะวิศวะฯ ถ้าจุฬาพัฒน์
...
*"ต้องยื่นเรื่องขอใช้ห้องกับคณะวิศวะฯ"* — งานธุรการที่ระบบรู้ว่าเกิดขึ้นแล้วไม่
บอกใคร คือเรื่องที่จะไปโผล่เอาตอนสัปดาห์แรกของเทอม

ในหน้า `/rooms` แยกสองกลุ่มให้ชัด: จุฬาพัฒน์ขึ้นก่อน ส่วนกลุ่มคณะวิศวะฯอยู่ใต้
...
เรียก `autoAssign` สองรอบตามข้อ 2.4 (จุฬาพัฒน์ก่อน แล้วค่อยเปิดห้องคณะวิศวะฯ)
...
| 5 | orange | คาบที่ต้องยื่นเรื่องขอใช้ห้องคณะวิศวะฯ |
...
แล้วตามด้วย *"ต้องขออนุมัติก่อนใช้"* สำหรับ 3 ห้องของคณะวิศวะฯ ซึ่งการ์ดมี
...
- เคสที่ต้องผ่าน:
  ...
  10. เมื่อจุฬาพัฒน์เต็มในคาบหนึ่ง วิชาที่เหลือได้ห้องคณะวิศวะฯ และถูก mark ว่า
      ต้องขออนุมัติ
